<template>
    <div class="fixed z-50 text-xs font-bold text-black p-2">
        <span class="inline-block xs:hidden rounded px-1 bg-yellow-400 p-1">xXS</span>
        <span class="hidden xs:inline-block sm:hidden rounded px-1 bg-yellow-400 p-1">XS</span>
