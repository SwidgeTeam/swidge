...
<template>
    <div class="flex flex-col field--amount-out pt-2">
        <span class="amount-tokens leading-5 text-left text-2xl font-bold">{{ amountOut }}</span>
        <span class="amount-dollars leading-5 flex justify-between items-center text-[13px] text-slate-500 hover:text-slate-400">
            <span
