...
<template>
    <div class="ml-1">
        <button
            class="flex grid w-16 h-10 mx-2 px-4 py-2 text-base sm:text-lg sm:h-12 text-center focus:outline-none cursor-pointer border rounded-lg border-slate-600"
            ...
            @click="onSlippageChange(value)">{{ content }}</button>
    </div>
</template>
